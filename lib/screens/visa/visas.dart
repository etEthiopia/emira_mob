        ...
        body: Container(
          ...
          child: Column(
            children: <Widget>[
              Container(
                padding:
                    EdgeInsets.only(right: 20, left: 20, bottom: 30, top: 5),
                decoration: BoxDecoration(
                    color: grey,
                        ...
                        children: [
                          ...
                          DropdownButton(
                            ...
                            style: TextStyle(
                                ...
                                fontSize: 17,
                                fontWeight: FontWeight.bold),
                            items: FBService.rateTypes.keys.map((String item) {
                              return DropdownMenuItem(
                                  enabled: FBService.rateTypes[item] != 0,
                                  value: item,
                                  child: Text(item));
                            }).toList(),
                            onChanged: (String? newValue) {
                              if (newValue is String) {
                                ...
                                //   AppLocalizations.currency = newValue;
                                // });
                                AppLocalizations.storecurrency(newValue);
                                getPostsData();
                              }
                            },
                          ),
